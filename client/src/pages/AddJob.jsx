...
const AddJobHandle=(e)=>{
    e.preventDefault();
    console.log({jobLocation,company,jobPosition,jobStatus,jobType});
...
return (
    <div className="w-full h-[80vh] flex items-start justify-center p-4  ">
      <div className="w-full max-w-5xl  shadow-xl rounded-2xl p-8 bg-white">
        <h1 className="text-4xl font-bold text-center mb-8 text-gray-800 ">Add Job</h1>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 ">
          <div>
            <label htmlFor="position" className="block text-lg font-medium text-gray-700 mb-1">Position</label>
            <input
              type="text"
              id="position"
          ...
          <div>
            <label htmlFor="jobLocation" className="block text-lg font-medium text-gray-700 mb-1">Job Location</label>
            <input
              type="text"
              id="jobLocation"
              className="w-full px-4 py-2 rounded-full border border-gray-300 focus:ring-2 focus:ring-blue-500 outline-none"
          ...
          <div>
            <label htmlFor="jobStatus" className="block text-lg font-medium text-gray-700 mb-1">Job Status</label>
            <select
              id="jobStatus"
              className="w-full px-4 py-2 rounded-full border border-gray-300 focus:ring-2 focus:ring-blue-500 outline-none"
        ...
        <div className="mt-10 flex justify-center">
          <button className="bg-blue-600 text-white px-8 py-3 rounded-full font-semibold hover:bg-blue-700 transition duration-300" onClick={AddJobHandle}>
            Submit
          </button>
        </div>
      </div>
